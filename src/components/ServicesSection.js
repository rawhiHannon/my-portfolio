          ...
          <div className="md:hidden relative">
            ...
            <div className="px-12">
              ...
              >
                <div className="relative p-8 bg-white/90 backdrop-blur-xl border border-gray-200/50 rounded-2xl hover:bg-white transition-all duration-500 group-hover:scale-105 group-hover:border-cyan-400/50 h-80 flex flex-col shadow-xl shadow-gray-900/5 hover:shadow-2xl hover:shadow-cyan-500/10">
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${services[currentIndex].gradient} opacity-0 group-hover:opacity-5 rounded-2xl transition-opacity duration-500`}
                  />
                  <motion.div
                  ...
                  <motion.div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-400 to-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 rounded-b-2xl" />
                </div>
              </motion.div>
            </div>
              ...
              {services.map((_, idx) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-200 ${
                    idx === currentIndex ? 'bg-cyan-500 scale-125 shadow-lg' : 'bg-gray-300 hover:bg-gray-400'
                  }`}
                />
              ))}
            </div>
